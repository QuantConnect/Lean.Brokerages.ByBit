...
namespace QuantConnect.BybitBrokerage.Tests
{
    ...
    public class BybitBrokerageHistoryProviderTests
    {
        private static TestCaseData[] TestParameters
        {
            get
            {
                return new[]
                {
                    ...
                    new TestCaseData(Symbol.Create("BTCUSDT",SecurityType.Crypto, Market.Bybit), Resolution.Minute, TimeSpan.FromMinutes(10), TickType.Trade, typeof(TradeBar), false),
                    new TestCaseData(Symbol.Create("BTCUSDT",SecurityType.Crypto, Market.Bybit), Resolution.Daily, TimeSpan.FromDays(10), TickType.Trade, typeof(TradeBar), false),
                };
            }
        }
        ...
        public void GetsHistory(Symbol symbol, Resolution resolution, TimeSpan period, TickType tickType, Type dataType, bool throwsException)
        {
            TestDelegate test = () =>
            {
                var brokerage = new BybitBrokerage(Market.Bybit);
